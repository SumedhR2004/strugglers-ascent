    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="md:col-span-2 border border-brand-border bg-brand-card p-6 shadow-lg relative overflow-hidden flex flex-col sm:flex-row gap-6 justify-between items-center group">
          ...
          <div className="absolute inset-0 z-0 opacity-95 pointer-events-none transition-transform duration-1000 group-hover:scale-105">
            <img 
              src={`/rank_bg_${activeTier}.jpg`} 
              alt="" 
              className="w-full h-full object-cover filter brightness-[0.95] contrast-105 saturate-100"
            />
            {/* Smooth transition from dark text area on the left to bright image on the right */}
            <div className="absolute inset-0 bg-gradient-to-r from-[#0d0d0d] via-[#0d0d0d]/95 via-[#0d0d0d]/60 to-transparent" />
